...
* There is also an option to create the compiler settings csc.rsp in the ROOT folder of your ASSETS if the project alteration is not working as expected.
